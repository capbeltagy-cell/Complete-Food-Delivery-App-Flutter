...
class MonetizationSettings {
  const MonetizationSettings({this.merchantMonthly = 0, this.orderCommissionPercent = 0, this.deliveryCommissionPercent = 0, this.featuredStoreDaily = 0, this.featuredProductDaily = 0, this.sponsoredPostDaily = 0, this.propertyPackage = 0, this.jobPackage = 0, this.servicePackage = 0});
